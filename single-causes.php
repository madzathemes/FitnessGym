...
<div class="row">
	...
	<div class="col-lg-<?php if ($mt_layout != "full") { echo "8 "; echo $col_8; } else {  echo "12 "; } echo $mt_float_layout; ?> ">
				...
				<div class="flexslider"> 
					...
					<ul class="slides">
						...
						<?php if($slides!="") { ?>
							...
							<?php foreach($slides as $slide) { ?>
								...
								<?php } else if ($slide['slider_image'] != "") { ?>    
									...
									<li><img src="<?php echo aq_resize_url( $slide['slider_image'], $mt_image_width, $mt_portfolio_slider_height, 'false', 'true'); ?>" /></li>
						...
						<?php } else if(has_post_thumbnail()) { ?>
							...
							<li><img src="<?php echo aq_resize_url( $src[0], $mt_image_width, $mt_portfolio_slider_height, 'false', 'true'); ?>" /></li>
	...
	<?php if ($mt_layout != "full") { ?>
		...
		<div class="col-lg-4 <?php echo $mt_float_sidebar; echo $col_4; ?> ">
