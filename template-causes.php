				...
				<?php if ( has_post_thumbnail() ) : ?>		  
					<div class="entry-page-image entry-page-image-cause">
						<a href="<?php the_permalink(); ?>"><span class="dark-background-2"></span>
							<img class="cause-img"  src="<?php $src = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), array( 999,999 ), false, '' ); echo aq_resize_url( $src[0], $mt_image_width, $mt_portfolio_slider_height, 'false', 'true'); ?>" alt=""> 
						</a>
					</div>
				<?php endif; ?>	
			</header>
