			...
			<div class="flexslider fslider"> 
				...
				<ul class="slides">
					...
					<?php if($slides!="") { ?>
						...
						<?php foreach($slides as $slide) { ?>
							...
							<?php } else if ($slide['slider_image'] != "") { ?>    
								...
								<li><img src="<?php echo aq_resize_url( $slide['slider_image'], '960', $mt_portfolio_slider_height, 'false', 'true'); ?>" /></li>
					...
					<?php } else if(has_post_thumbnail()) { ?>
						...
						<li><img src="<?php echo aq_resize_url( $src[0], '960', $mt_portfolio_slider_height, 'false', 'true'); ?>" alt="<?php the_title(); ?>" /></li>
