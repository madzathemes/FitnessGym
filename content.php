			...
			<div class="entry-page-image">
				<div class="flexslider mt<?php echo $post->ID; ?>"> 
					<ul class="slides">
							...
							?>
							<li><a href="<?php the_permalink(); ?>"><span class="dark-background-2"></span><img  src="<?php $src = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), array( 999,999 ), false, '' ); echo aq_resize_url( $src[0], $mt_image_width, $height, 'false', 'true'); ?>" alt=""></a></li>
