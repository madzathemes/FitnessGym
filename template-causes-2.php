				...
				<?php if ( has_post_thumbnail() ) : ?>		  
					<div class="entry-page-image">
						 <a href="<?php the_permalink(); ?>">
						 	<img class="cause-img"  src="<?php $src = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), array( 999,999 ), false, '' ); echo aq_resize_url( $src[0], '300', '200', 'true', 'true'); ?>" alt="">
